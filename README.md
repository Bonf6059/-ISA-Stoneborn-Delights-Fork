...
- Add 2 potion active with ISA Medieval enabled called "Artisanal dream" and "Oven's breath"
    Specs: Artisanal dream boosts global work speed +25% and quality of the output +1 (?) lowers hunger -10% and sleepfall rate -15%
...
- Changed techlevel for various drugs from industrial to medieval and researches
- Locked some drugs behind stonecutting research
- Added slab door 1x1 and 2x1
- Added royal column
